...
#python d:/20201/AI/detect_03.py --hdf5 D:/20201/AI/result/weights01.hdf5 --image D:/20201/AI/leedsbutterfly/images/0070112.PNG
...
w=100
h=100
cv2.putText(img, str(label)+" : "+labels_dict[label],(x,y-10), cv2.FONT_HERSHEY_SIMPLEX, 0.8 , color_dict[label],2)
